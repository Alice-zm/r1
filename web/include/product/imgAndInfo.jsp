            ...
            $.get(
                ...
                function(result){
                    if("success"==result){
                        var pid = ${p.id};
                        var num= $(".productNumberSetting").val();
                        var addCartpage = "user_fore_addCart";
                        $.get(
                            addCartpage,
                            {"pid":pid,"num":num},
                            function(result){
...
<div class="imgAndInfo">
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="buyDiv">
            <a class="buyLink" href="user_fore_buyone?pid=${p.id}"><button class="buyButton">立即购买</button></a>

                ...
                <div>
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="admin_productImage_add?pid=${p.id}&type=type_single" enctype="multipart/form-data">
            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormDetail" action="admin_productImage_add?pid=${p.id}&type=type_detail" enctype="multipart/form-data">
                                <table class="addTable">
                                    <tr>

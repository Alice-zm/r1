...
$(function(){
	...
	$('#deleteConfirmModal').on('hidden.bs.modal', function (e) {
		if(deleteOrderItem){
			var page="user_fore_deleteOrderItem";
			$.post(
				    page,
	...
	$("button.createOrderButton").click(function(){
		...
		location.href="user_fore_buy?"+params;
	});
...
function syncPrice(pid,num,price){
	...
	var page = "user_fore_changeOrderItem";
	$.post(
		    page,
		    {"pid":pid,"number":num},
		    function(result){
					...
					<tr oiid="${oi.id}" class="cartProductItemTR">
						...
						<td>
							<div class="cartProductLinkOutDiv">
								<a href="user_fore_product?pid=${oi.product.id}" class="cartProductLink">${oi.product.name}</a>
